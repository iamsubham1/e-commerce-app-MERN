...
const Footer = () => {
    return (
        <footer className="bg-[#1a1a1a] text-[#FAF2E2] py-8 px-4 w-full">
                    ...
                    <div>
                        ...
                        <form>
                            <div className="flex">
                                ...
                                <button
                                    type="submit"
                                    className="bg-[#0c0c0c] hover:bg-[#fff3d1] hover:text-black text-white py-2 px-4 rounded-r-lg focus:outline-none"
                                >
                                    Subscribe
                                </button>
                            </div>
