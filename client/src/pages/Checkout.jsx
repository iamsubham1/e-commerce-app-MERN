...
const Checkout = () => {
  ...
  const handleOnlineOrder = async (paymentMode) => {
    try {
      ...
      const orderData = await placeOnlineOrder(
        transformedProducts,
        paymentMode,
        totalValue,
        phoneNumber
  ...
  return (
    <div className="container mx-auto p-4 flex flex-col md:flex-row justify-evenly ">
      ...
      />
      <div
        className={`mb-8 md:mb-0 py-8 px-6 rounded-lg md:w-2/5 ${
          ...
          <form>
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="mt-1 p-2 block w-full shadow-sm rounded-md border-2 border-gray-400"
                />
              </div>
              <div>
                <label
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleAddressChange}
                  className="mt-1 p-2 block w-full shadow-sm border-2 border-gray-400 rounded-md"
                />
              </div>
              <div>
                <label
            ...
            <div className="mt-4">
              <button
                ...
                className="shine-btn mt-2 rounded"
              >
                Save Address
              </button>
            </div>
            ...
            {addresses?.length > 0 ? (
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="text-md ml-5 capitalize">
                      <h1 className="text-2xl mb-2 capitalize text-[#000000]">
                        {address.type}
                      </h1>
                  ...
                  <MdDelete
                    ...
                    className="cursor-pointer text-red-500 justify-stretch "
                  />
                </div>
              ))
            ) : (
              <div className="flex flex-col mt-12 justify-center items-center">
                {isFormOpen ? (
                  ...
                  <p className=" mt-10 text-center mb-10">
      ...
      <div className="w-full md:w-2/5 bg-[#f4f4f4] text-[#000000] rounded-lg py-8 px-6 h-[60%]">
        ...
        <button
          className={`shine-btn mt-4 rounded ${
            addresses?.length < 1 || selectedAddresses.length === 0
              ? "opacity-50 cursor-not-allowed"
              : "opacity-100 cursor-pointer shine-btn hover:scale-105"
          }`}
          onClick={
            addresses?.length > 0 && selectedAddresses.length > 0
              ? openModal
              : null
          }
