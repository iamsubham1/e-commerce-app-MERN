...
const Phones = () => {
    ...
    const productCard = (product) => (
        <div key={product._id} className='product-card' onClick={() => navigate(`/product/${product._id}`)}>
            <img src={product.pictures ? product.pictures[0] : "https://via.placeholder.com/300"} alt={product.name} className="product-image" />
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="hero-banner w-full h-64 bg-cover bg-center mb-8 flex items-center justify-center">
                <div className="bg-black bg-opacity-50 p-4 rounded-lg">
                    <h1 className="text-4xl text-white font-bold">Shop the Latest Phones</h1>
                </div>
            </div>
