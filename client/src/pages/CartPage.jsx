      ...
      {items && items.length !== 0 ? (
        <div className="flex flex-col md:flex-row gap-4">
          <div className="w-full md:w-3/5 overflow-y-scroll ">
            <ul className="h-[60vh]">
              {items.map((item) => (
                <li
                  key={item._id}
                  className="border-b border-gray-200 py-4 px-2 flex text-sm md:text-base gap-2 items-center hover:bg-[#f1f1f1] hover:cursor-pointer"
                ...
                >
                  ...
                  <div className="mb-2 sm:mb-0 sm:w-auto flex-[0.8] ">
                    {item.product.name}
                  </div>
                  <div className="mb-2 sm:mb-0 sm:w-1/6 ">
                  ...
                  <div className="mb-2 sm:mb-0 sm:w-1/6 flex items-center gap-2 ">
                    <div className="flex ">
                      <button
                        className="text-black rounded-full mr-3 bg-[#e6e6e6] px-[4px] hover:bg-[#d7d7d7]"
                        onClick={(e) => {
                          e.stopPropagation();
                      ...
                      <span className="px-2 bg-[#000000] text-[#ffffff] rounded">
                        {item.quantity}
                      </span>
                      <button
                        className="text-black rounded-full ml-3 bg-[#e8e8e8] px-[4px] hover:bg-[#d7d7d7]"
                        onClick={(e) => {
                          e.stopPropagation();
          ...
          <div className="w-full md:w-2/5 bg-[#f4f4f4] text-[#000000] rounded-lg py-8 px-6 h-[60%]">
            ...
            <button
              className="shine-btn rounded-md mt-8"
            ...
            <button
              className="btn-clear-cart text-xs text-red-500 mt-4"
        ...
        <div className="container flex flex-col justify-center items-center">
          ...
          <button className="shine-btn mt-8" onClick={() => navigate("/")}>
            Shop Now !
          </button>
        </div>
      )}
