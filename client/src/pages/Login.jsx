...
const Login = () => {
  ...
  const handleGoogleLogin = (e) => {
    e.preventDefault();
    window.open(
      "https://e-commerce-app-mern-bmty.onrender.com/api/auth/google",
      "_self"
    );
  };
  useEffect(() => {
    ...
    <>
      <div className="flex justify-center items-center h-[90vh] ">
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md border-2 border-[#eeeeee]">
          <h2 className="text-5xl font-bold mb-4 heading-font text-center">
            Welcome Back !
          </h2>
          <form>
            <div className="mb-4">
            ...
            <div className="mb-4 relative">
              ...
              <p className="mt-4">
                Forgot Password ?{" "}
                <Link to="/reset" className="text-slate-400 hover:">
                  Reset
                </Link>
              </p>
            ...
            <div className="mt-4 flex items-center gap-4 flex-col-reverse ">
              ...
              <button
                type="submit"
                className="w-[100%] shine-btn rounded-md"
                onClick={handleLogin}
              >
                Login
              </button>
          ...
          <p className="text-center mt-4">
            ...
            <a href="/signup" className="text-slate-500  hover:text-black">
              Sign Up
            </a>
          </p>
        </div>
