                    ...
                    {selectedCategory == "" ? (<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-10 mt-8 px-12">
                        {productsLoading ? (
                            ...
                            currentProducts.map((product) => (
                                <div key={product._id} className="shadow-md overflow-hidden flex p-4 card flex-col items-center justify-center" onClick={() => handleProductClick(product._id)}>
                                    ...
                                    <div className="p-4 flex flex-col items-center ">
                                        ...
                                        <button
                                            ...
                                            className={`mt-4 text-white font-bold py-2 px-4 rounded primary-button ${addingToCart && 'disabled-button'}`}
                                        >
                                            Add to Cart
                                        </button>
                                    </div>
